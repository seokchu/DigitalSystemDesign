module top_standalone (
    ...
    always @* begin
        ...
        case (phase)
            ...
            6'd5 : begin w_fsm_state=3'b010; end

            6'd6 : begin w_fsm_state=3'b100; w_lock=1'b1; end
            6'd7 : begin w_fsm_state=3'b100; end
            6'd8 : begin w_fsm_state=3'b100; end
            6'd9 : begin w_fsm_state=3'b100; end
            6'd10: begin w_fsm_state=3'b100; end
            6'd11: begin w_fsm_state=3'b100; end
            6'd12: begin w_fsm_state=3'b100; end
